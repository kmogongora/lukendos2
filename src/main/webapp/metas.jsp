                ...
                <div class="card">
                    ...
                    <form method="POST" action="registroMetas.jsp">
                        <div class="card-body">
                            ...
                            <!-- ID de la Meta-->
                            <div class="row mb-3">
                                <label for="txtIdMetas" class="col-form-label col-sm-5 "><i class="fas fa-barcode"></i> Codigo de la Meta</label>
                                <input type="text" class="form-control col-sm-6" id="txtIdMetas" name="txtIdMetas" value="<%= id%>" readonly>
                            </div>
                            <!-- Nombre-->
                            <div class="row mb-3">
                                <label for="txtNombre" class="col-form-label col-sm-5 "><i class="fas fa-file-alt"></i> Nombre</label>
                                <input type="text" class="form-control col-sm-6" id="txtNombre" name="txtNombre" value="<%= nombre%>"  placeholder="Nombre corto">
                            </div>             
                            <!-- Valor Total de la Meta-->
                            <div class="row mb-3">
                                <label for="txtValorTotalMeta" class="col-form-label col-sm-5 "><i class="fas fa-dollar-sign"></i> Valor Total</label>
                                <input type="text" class="form-control col-sm-6" id="txtValorTotalMeta" name="txtValorTotalMeta" value="<%= valorTotal%>" required placeholder="Valor">
                            </div> 
                            <!-- Valor ahorrado para la Meta-->
                            <div class="row mb-3">
                                <label for="txtValorParcialMeta" class="col-form-label col-sm-5 "><i class="fas fa-money-bill-wave"></i> Dinero Ahorrado</label>
                                <input type="text" class="form-control col-sm-6" id="txtValorParcialMeta" name="txtValorParcialMeta" value="<%= valorParcial%>" required placeholder="Valor">
                            </div> 
                            <!-- Fecha Objetiva de la Meta-->
                            <div class="row mb-3">
                                <label for="dtpFechaObjetivaMeta" class="col-form-label col-sm-5"><i class="far fa-calendar-alt"></i> Fecha Objetiva</label>
                                <input type="date" class="form-control col-sm-6" id="dtpFechaObjetivaMeta" name="dtpFechaObjetivaMeta" value="<%= fechaObjetiva%>" required>
                            </div> 
                    ...
                    <div class="card-content">               
                        <div class="card-body">                   
                            ...
                            <div class="progress" style="height: 15px;">
                                <%
                                    if (progresoMeta <= 25) { %>
                                <div class="progress-bar bg-danger progress-bar-striped progress-bar-animated" role="progressbar" style="width: <% out.print(progresoMeta); %>%" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<%out.print(progresoMeta); %>"><% out.print(porciento.format(progresoMeta)); %>%</div>
                                <%    } else if (progresoMeta > 25 && progresoMeta <= 50) { %>
                                <div class="progress-bar bg-warning progress-bar-striped progress-bar-animated" role="progressbar" style="width: <% out.print(progresoMeta); %>%" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<%out.print(progresoMeta); %>"><% out.print(porciento.format(progresoMeta)); %>%</div>
                                <%    } else if (progresoMeta > 50 && progresoMeta <= 75) {%>
                                <div class="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style="width: <% out.print(progresoMeta); %>%" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<%out.print(progresoMeta); %>"><% out.print(porciento.format(progresoMeta)); %>%</div>
                                <%    } else {%>
                                <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" style="width: <% out.print(progresoMeta); %>%" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<%out.print(progresoMeta); %>"><% out.print(porciento.format(progresoMeta)); %>%</div>
                                <%    } %>
                            </div>
                        </div>
                    </div>
